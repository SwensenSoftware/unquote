versionNumber=$1
net45lib=/Library/Frameworks/Mono.framework/Versions/3.4.0/lib/mono/4.5
...
echo "preparing nuget dirs..."

mkdir ./nuget
mkdir ./nuget/lib
mkdir ./nuget/lib/net45
mkdir ./nuget/lib/net40
mkdir ./nuget/lib/sl4
cp ./Unquote.nuspec ./nuget

echo "copy staging builds to nuget package..."

cp ./staging/net45/Unquote.dll ./nuget/lib/net45/Unquote.dll
cp ./staging/net45/Unquote.xml ./nuget/lib/net45/Unquote.xml
